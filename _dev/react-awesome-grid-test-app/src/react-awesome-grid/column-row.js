...
export default class ColumnRow extends Component {
    ...
    render() {
        ...
        // Wrap in Align block?
        if (
            this.props.horizontalContentAlignment ||
            this.props.verticalContentAlignment
        ) {
            return (
                <BaseElement style={this.itemStyle}>
                    <Align
                        horizontalAlignment={
                            this.props.horizontalContentAlignment || "left"
                        }
                        verticalAlignment={this.props.verticalContentAlignment || "top"}
                    >
                        {this.props.children}
                    </Align>
                </BaseElement>
            ...
            return (
                <BaseElement style={this.itemStyle}>{this.props.children}</BaseElement>
            );
        }
    }
}
